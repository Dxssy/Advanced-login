    ...
    return (
      <Tab.Navigator
        ...
        <Tab.Screen
          ...
          options={{
            tabBarIcon: ({color}) => (
              <MaterialCommunityIcons name="clock" color={'#ff9d5c'} size={26} />
            ),
          }}
        />
        <Tab.Screen
          ...
          options={{
            tabBarIcon: ({color}) => (
              <MaterialCommunityIcons name="clock-check" color={'#ff9d5c'} size={26} />
            ),
          }}
        />
        <Tab.Screen
          ...
          options={{
            tabBarIcon: ({color}) => (
              <MaterialCommunityIcons name="newspaper" color={'#ff9d5c'} size={26} />
            ),
          }}
        />
      </Tab.Navigator>
