...
export default class Horas extends Component {
    ...
    cerrarSesion = async () => {
        ...
        try {
            ...
            this.props.navigation.navigate('Proyecto');
        } catch (error) {
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.vista}>
        <Text style={styles.nombre}>{nombreAlumno} </Text>
      </View>

      <View style={{marginTop: 15}}>
        <Text style={{textAlign: 'left', fontWeight: 'bold', fontSize: 25, color: 'black'}}>   </Text>
      </View>

      <View style={styles.hora}>
      <Text style={styles.nombre}>{codigoAlumno}</Text>
      </View>
...
const styles = StyleSheet.create({
    ...
    hora: {
        borderWidth: 2, height: 50, marginLeft: 163, marginTop: -98
    }
